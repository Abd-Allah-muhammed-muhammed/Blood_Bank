...
public class PostesDatum {

    @SerializedName("category")
    private PostesCategory mPostesCategory;
    ...
    public PostesCategory getCategory() {
        return mPostesCategory;
    }

    public void setCategory(PostesCategory postesCategory) {
        mPostesCategory = postesCategory;
    }
